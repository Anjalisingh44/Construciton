...
const OutsourceSection = () => {
  ...
  <h2 className=" text-3xl text-sky-600 leading-[56px] font-semibold text-center font-['Roboto']">
    Our Team
  </h2>
  <p className="text-lime-600 text-[16px] leading-[24px] font-normal text-center font-['Roboto']">

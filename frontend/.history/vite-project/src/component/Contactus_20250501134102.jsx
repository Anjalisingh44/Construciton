...
import contact from '../assets/uss.png'

const Contactus = () => {
  return (
    <div className="bg-[#f9ede5] min-h-screen flex items-center justify-center">
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-20">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1">
          <img src={uss} alt="Contact Illustration" className="w-full max-w-sm" />
        </div>
      </div>
    </div>
  );

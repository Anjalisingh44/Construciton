...
const Ourservices = () => {
  ...
  return (
<div >
  <h1 className="flex items-center justify-center"> Our Services</h1>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 flex flex-col justify-center">
            ...
            <button className="bg-red-600 text-white px-6 py-3 rounded-full flex items-center gap-2 w-fit hover:bg-red-700 transition-colors">

...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-100" ref={ref}>
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row  gap-12 px-6">
        
        {/* Left: Image */}
        <motion.div
          className="w-full lg:flex-[0.8] "
        ...
        >
          <img
            ...
            className="rounded-xl shadow-lg w-full h-[600px]  object-scale-down"
          />
        </motion.div>

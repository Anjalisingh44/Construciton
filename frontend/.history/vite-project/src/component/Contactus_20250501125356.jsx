...
const Contactus = () => {
  return (
    <div className="bg-[#f9ede5] min-h-screen flex items-center justify-center p-8">
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-8">
        
      
        <div className="bg-white p-8 rounded-md shadow-md flex-1 relative">
          ...
          <div className= "absolute -bottom-6 object-right-top bg-[#001F4D] text-white p-8 rounded-md shadow-md flex-1 -bottom-6 -right-6">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1">
          <img src="/assets/logo.png" alt="Contact Illustration" className="w-full max-w-sm" />
        </div>
      </div>
    </div>
  );

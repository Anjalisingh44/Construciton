...
<div  id='ourservices' className="px-4 sm:px-6 lg:px-20">
  <h1 className="text-3xl font-bold text-center mb-10 text-sky-600"> Our Services</h1>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 flex flex-col justify-center">
            ...
            <button onClick={() => navigate(`/${services.id.toLowerCase()}`)} className="bg-sky-600 text-white px-6 py-3 rounded-full flex items-center gap-2 w-fit hover:bg-sky-900 transition-colors">

...
const Contactus = () => {
  return (
    ...
    <div className="bg-[#f9ede5] w-full flex flex-col items-center justify-center h-screen">
     <div className="mb-16">
    <h1 className="text-3xl font-bold text-[#001F4D] flex justify-center items-center">Send Your Message</h1>
    <p className="text-gray-600 mt-2">
      Don’t hesitate to ask us something. Our customer support team is always ready to help you, 24/7.
    </p>
  </div>  
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-44">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-md flex-1 relative">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1">
          <img src={uss} alt="Contact Illustration" className=" " />
        </div>
      </div>
    </div>
  );

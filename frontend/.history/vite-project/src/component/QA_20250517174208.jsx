...
const QA = () => {
  ...
  return (
    <div className="py-16 bg-gradient-to-br from-white via-sky-50 to-white min-h-screen" id="faq">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-sky-700 mb-12">बारम्बार सोधिने प्रश्नहरू (FAQ)</h2>
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`transition-all duration-300 transform hover:scale-[1.01] hover:shadow-xl cursor-pointer bg-white border border-gray-200 rounded-xl p-6 shadow-md ${
                openIndex === index ? "rotate-[1deg] shadow-sky-300" : "hover:-rotate-[1deg]"
              }`}
            >

    ...
    >
      <div className="max-w-[1440px] mx-auto flex items-center justify-between px-[109px] h-[521px]">
        ...
        <div className="w-[599px] flex flex-col gap-6">
          <div>
            <h1 className="text-blue-500 text-[48px] font-extrabold leading-tight">
              Get instant cash <br />
              flow with invoice <br />
              factoring
            </h1>
            <p className="text-blue-600 text-base mt-4">
              Why wait? Get same day funding and a faster way to access cash flow.
            </p>
          </div>

          <div className="">
            <button className="bg-white text-[#4F46E5] px-6 py-2 rounded-full font-medium text-[16px]">
              Get started
            </button>

...
const Home = () => {
  return (
    <div className="overflow-x-hidden">
     <section
  id="home"
  className="relative pt-[96px] w-full min-h-[600px] lg:min-h-[700px] bg-gradient-to-br from-cyan-300 via-sky-100 to-white overflow-hidden"
>
  {/* Background Image */}
  <img
    src={home}
    alt="Home Background"
    className="hidden sm:block absolute inset-0 w-full h-full object-cover object-right-bottom z-0"
  />
  ...
  <div className="relative z-20 max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 md:px-12 lg:px-[109px] h-full">
    {/* Left side: Text */}
    <div className="w-full max-w-[599px] flex flex-col gap-6">
      <motion.h1
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-6">
        <button className="bg-cyan-600 text-white px-6 py-2 rounded-full font-medium text-[16px]">
          Get In Touch
        </button>

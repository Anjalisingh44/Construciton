    ...
    <div className="overflow-x-hidden">
      <section id="home" className="relative pt-[96px] h-auto lg:h-[600px]">
        ...
        transition={{ duration: 1 }}
          className="text-white text-[20px] sm:text-[30px] font-bold leading-tight"
        >
        ...
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1 }}
          className="text-white text-[16px] mt-4 font-semibold "
        >
          From residential to commercial, we deliver safe, on-time, and cost-effective construction  
            ...
            <div>
              <button className="bg-white text-[#0284C7] px-6 py-2 rounded-full font-medium text-[16px]  mb-">
                Get In Touch
              </button>

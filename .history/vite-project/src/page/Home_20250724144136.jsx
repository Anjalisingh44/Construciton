...
import home from '../assets/homeee.jpeg'
    ...
    >
      <div className="max-w-[1440px] mx-auto flex items-center justify-between px-[109px] h-[521px]">
        ...
        <div className="w-[599px] flex flex-col gap-6">
          <div>
            <h1 className="text-sky-600 text-[32px] font-bold leading-tight">
              Building Structures That Last.
From residential to commercial, we deliver safe, on-time, and cost-effective construction — without cutting corners. <br />
             From residential to commercial, we deliver safe, on-time, and cost-effective construction  <br />
              factoring
            </h1>

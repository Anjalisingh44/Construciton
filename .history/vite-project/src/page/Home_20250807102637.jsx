...
const Home = () => {
  return (
   < div className='overflow-x-hidden'>
    ...
    style={{backgroundImage:`url(${home})`, backgroundSize: 'contain', backgroundPosition: 'center',backgroundRepeat: 'no-repeat',height: '100vh' // or set according to your container
  width: '100%'}}
    >
 ...
 <br />
          ...
          <div className="">
            <button className="bg-white text-[#0284C7] px-8 py-3 sm:px-6 sm:py-2 rounded-full font-medium text-[16px]">
              Get started
            </button>

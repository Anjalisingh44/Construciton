...
const Home = () => {
  return (
    <div className="overflow-x-hidden">
      <section id="home" className="relative pt-[96px] h-auto lg:h-[600px] bg-gradient-to-br from-cyan-300 via-sky-100 to-white">
        
        {/* Background Image */}
        <img
          src={home}
          alt="Home Background"
          className="hidden sm:block absolute  left-0 w-full h-full z-0 object-contain object-right-bottom"
        />

        {/* Overlay dim layer */}
        <div className="absolute left-0 w-full h-full  opacity-60 z-10"></div>

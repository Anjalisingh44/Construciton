  ...
  return (
    <div className="overflow-x-hidden">
      <section id="home" className="relative pt-[96px] h-auto lg:h-[600px]">
        ...
        {/* Main Content */}
        <div className="relative z-20 max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 md:px-12 lg:px-[109px] h-full bg-red-400">
          {/* Left side: Text */}
        ...
        transition={{ duration: 1 }}
          className="text-white text-[26px] sm:text-[30px] font-bold leading-tight"
        >
        ...
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1 }}
          className="text-white text-[24px] mt-4 font-semibold"
        >

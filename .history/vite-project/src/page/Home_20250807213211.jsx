...
import home from '../assets/about.jpeg'

const Home = () => {
  return (
    <div className="overflow-x-hidden">
      <section id="home" className="relative pt-[96px] h-auto lg:h-[650px]">
        
        {/* Background Image */}
        <img
          src={home}
          alt="Home Background"
          className="absolute top-0 left-0 w-full h-full bg-contain z-0"
        />

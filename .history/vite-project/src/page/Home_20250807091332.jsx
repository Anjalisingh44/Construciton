...
const Home = () => {
 ...
 <br />
            ...
            <p className="text-white text-[18px] sm:text-[24px] mt-4 font-semibold">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-start gap-4 sm:gap-6">
            <button className="bg-white text-[#0284C7] px-6 py-2 rounded-full font-medium text-[16px] w-max">
              Get started
            </button>

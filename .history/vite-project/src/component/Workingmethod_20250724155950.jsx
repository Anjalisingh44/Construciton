...
const Workingmethod = () => {
  return (
    <section className="bg-gradient-to-br from-white via-sky-50 to-white text-white py-10 w-full">
      <h2 className="text-3xl font-bold text-center mb-12">Homeplex Working Process</h2>

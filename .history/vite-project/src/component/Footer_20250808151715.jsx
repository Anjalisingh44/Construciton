...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-12 px-4 lg:px-16">
  ...
  <a href="https://wa.me/yourphonenumber" target="_blank" rel="noopener noreferrer">
    <FaWhatsapp />
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-700 mt-10 pt-6 text-sm text-white flex flex-col lg:flex-row justify-between items-center">

  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-6 md:px-12 lg:px-24 items-center">
        ...
        <div className="relative rounded-3xl overflow-hidden border border-cyan-700 bg-gradient-to-br from-cyan-700 via-cyan-600 to-cyan-500 shadow-lg max-h-[520px] flex items-center justify-center p-12 text-white text-center">
          <div>

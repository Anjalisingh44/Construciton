...
const Workingmethod = () => {
  return (
    <section className="bg-gradient-to-br from-white via-sky-50 to-white text-black py-8 w-full">
      <h2 className="text-2xl text-cyan-600 font-bold text-center mb-12">Homebizz Working Process</h2>

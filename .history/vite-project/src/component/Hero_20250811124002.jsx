  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-6 md:px-12 lg:px-24 items-center">
        ...
        <div className="relative rounded-3xl overflow-hidden border border-cyan-700 bg-gradient-to-br from-cyan-700 via-cyan-600 to-cyan-500 shadow-lg max-h-[420px] flex items-center justify-center p-12 text-white text-center max-w-[600px]">
          <div>
            <h2 className="text-xl font-bold mb-5 tracking-wide">
              Building Dreams Into Reality
            </h2>
            <p className="text-xl max-w-md mx-auto mb-8 leading-relaxed">

...
const steps = [
  ...
  },
  {
    ...
    description: 'After verifying your order, we will aim to arrive at your doorstep within 2 hours.',
    icon: <FaClock className="text-5xl mx-auto text-yellow-400 mb-3" />,
  },
  {
    title: 'Your Problem Solved',
    description: 'Homeplex experts solve your problems carefully without causing any damage.',
    icon: <FaTools className="text-5xl mx-auto text-pink-400 mb-3" />,
  },
  {
    title: 'Billing',
    description: 'We will charge according to our rates with a discount applied.',
...
const Workingmethod = () => {
  return (
    ...
    <div className="w-screen bg-gradient-to-br from-white via-sky-50 to-white text-black py-16">

    ...
    >
      <div className="mb-10 max-w-3xl text-center">
        ...
        <p className="text-lime-600 mt-5">
          Don’t hesitate to ask us something. Our customer support team is always 
          <br />
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-12 lg:gap-44">
        ...
        {/* Right: Illustration */}
        <div className="flex flex-col items-center justify-center w-full px-4 py-8 lg:flex-1">

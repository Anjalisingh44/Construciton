...
const projectData = [
  {
    ...
    image: renovation,
    description: "A high-rise apartment project focused on modern urban living.",
  },
  {
    id: 2,
  ...
  return (
    <section id='projects' className="px-6 py-12 bg-gradient-to-br from-white via-sky-50 to-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-10 text-cyan-600">Our Projects</h2>

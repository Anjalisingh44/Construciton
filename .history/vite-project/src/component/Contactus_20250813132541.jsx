  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-12 lg:gap-44">
        ...
        {/* Right: Illustration */}
        <div className="flex flex-col items-center justify-center w-full lg:flex-1 py-0">
         <div className=" w-full max-w-md px-4 sm:px-5 mx-auto ">
           <h2 className="text-2xl font-semibold mb-2 text-center text-cyan-600">Our Location</h2>
      <iframe
        title="Kathmandu Map"

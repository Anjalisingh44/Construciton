    ...
    >
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-6 md:px-12 lg:px-24 items-center">
        ...
        <div className="max-w-xl">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 leading-tight mb-8">
        ...
        <div className="relative rounded-3xl overflow-hidden border border-cyan-700 bg-gradient-to-br from-cyan-700 via-cyan-600 to-cyan-500 shadow-lg max-h-[420px] flex items-center justify-center p-12 text-white text-center">
          <div>
            ...
            <div className="inline-flex gap-8">
              <div className="flex flex-col items-center">
                <span className="text-4xl font-extrabold leading-none">250+</span>
                <span className="text-sm uppercase tracking-widest">Projects</span>
              </div>
              <div className="flex flex-col items-center border-l border-white/50 pl-8">
              ...
              <div className="flex flex-col items-center border-l border-white/50 pl-8">
                <span className="text-4xl font-extrabold leading-none">99%</span>

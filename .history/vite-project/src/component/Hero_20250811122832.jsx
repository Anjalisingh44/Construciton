      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 px-6 md:px-12 lg:px-24 items-center">
        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row sm:gap-6 gap-4">
            <a
              href="#quote"
              className="inline-block rounded-md bg-gradient-to-rbg-gradient-to-br from-cyan-600 via-cyan-500 to-cyan-700 px-8 py-3 text-white font-semibold shadow-lg transition hover:from-teal-700 hover:to-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-300"
            >
              Get a Free Quote
            </a>

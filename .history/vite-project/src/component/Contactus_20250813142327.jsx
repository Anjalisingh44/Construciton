...
const Contactus = () => {
  return (
    ...
    >
      ...
      {/* Main Flex Container */}
      <div className="flex flex-col lg:flex-row w-full max-w-7xl gap-12 lg:gap-16 justify-center items-start">
        ...
        <div className="flex-1 lg:max-w-lg relative">
          ...
          <div className="bg-gradient-to-br from-white via-sky-50 to-white p-8 rounded-2xl shadow-md">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-sky-600 text-white px-6 py-2 mt-4 rounded hover:bg-sky-900 flex items-center gap-2 justify-center w-full"
              >
                Submit
              </button>
            </form>
          ...
          {/* Contact Info Box */}
          <div className="mt-10 lg:absolute lg:-bottom-12 lg:right-0 bg-sky-600 text-white rounded-2xl shadow-md p-7 w-full max-w-md lg:w-72">

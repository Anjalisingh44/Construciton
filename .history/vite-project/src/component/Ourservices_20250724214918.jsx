...
const services = [
  ...
  },
  {
    ...
    image: "/placeholder.svg", // You can update this later with an actual image
    ...
    <>
      <div id="ourservices" className="px-4 sm:px-6 lg:px-20">
        ...
        <div className="bg-white min-h-screen py-12">
          ...
          {/* Optional: Feature section at bottom */}
          <Feature />
        </div>
      </div>
    </>
...
import realestateThumb from "../assets/realestate-icon.png";
